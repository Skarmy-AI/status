...
def test_summary_matches_config(upptimerc, history_summary):
    ...
    # summary.json is regenerated by the Upptime bot after config changes, so
    # it may lag behind .upptimerc.yml. Only require that every summarized site
    # is still configured.
    assert summarized <= configured
